...
function(vp_block)
    ...
    if(${BUILD_OPTIMIZED})
        ...
        get_target_property(GVSOC_INCLUDE_DIRS gvsoc INTERFACE_INCLUDE_DIRECTORIES)
        target_include_directories(${VP_MODEL_NAME_OPTIM} PRIVATE ${GVSOC_INCLUDE_DIRS})
    ...
    if(${BUILD_OPTIMIZED_M32})
        ...
        get_target_property(GVSOC_INCLUDE_DIRS gvsoc_m32 INTERFACE_INCLUDE_DIRECTORIES)
        target_include_directories(${VP_MODEL_NAME_OPTIM_M32} PRIVATE ${GVSOC_INCLUDE_DIRS})
    ...
    if(${BUILD_DEBUG})
        ...
        get_target_property(GVSOC_DEBUG_INCLUDE_DIRS gvsoc_debug INTERFACE_INCLUDE_DIRECTORIES)
        target_include_directories(${VP_MODEL_NAME_DEBUG} PRIVATE ${GVSOC_DEBUG_INCLUDE_DIRS})
    ...
    if(${BUILD_DEBUG_M32})
        ...
        get_target_property(GVSOC_INCLUDE_DIRS gvsoc_debug_m32 INTERFACE_INCLUDE_DIRECTORIES)
        target_include_directories(${VP_MODEL_NAME_DEBUG_M32} PRIVATE ${GVSOC_INCLUDE_DIRS})
...
function(vp_model)
    ...
    if ("${CONFIG_${VP_MODEL_NAME}}" EQUAL "1" OR DEFINED CONFIG_BUILD_ALL OR DEFINED VP_MODEL_FORCE_BUILD)
        ...
        if(${BUILD_DEBUG})
            ...
            get_target_property(GVSOC_INCLUDE_DIRS gvsoc_debug INTERFACE_INCLUDE_DIRECTORIES)
            target_include_directories(${VP_MODEL_NAME_DEBUG} PRIVATE ${GVSOC_INCLUDE_DIRS})
            set_target_properties(${VP_MODEL_NAME_DEBUG} PROPERTIES PREFIX "")
            target_compile_options(${VP_MODEL_NAME_DEBUG} PRIVATE "-D__GVSOC__")
            target_compile_definitions(${VP_MODEL_NAME_DEBUG} PRIVATE -DVP_TRACE_ACTIVE=1 -DVP_MEMCHECK_ACTIVE=1)
...
function(vp_model_link_gvsoc)
    ...
    if ("${CONFIG_${VP_MODEL_NAME}}" EQUAL "1" OR DEFINED CONFIG_BUILD_ALL OR DEFINED VP_MODEL_FORCE_BUILD)
        foreach (TARGET_TYPE IN LISTS VP_TARGET_TYPES)
            ...
            get_target_property(GVSOC_INCLUDE_DIRS gvsoc${TARGET_TYPE} INTERFACE_INCLUDE_DIRECTORIES)
            target_include_directories(${VP_MODEL_NAME_TARGET} PRIVATE ${GVSOC_INCLUDE_DIRS})
        endforeach()
    endif()
endfunction()
