...
for task in "${ordered_tasks[@]}"; do
    ...
    case $task_number in
        1) binary_path="./core/docs/developer_manual/tutorials/hwpe/model_hwpe/application/task1/test" ;;
        2) binary_path="./core/docs/developer_manual/tutorials/hwpe/model_hwpe/application/task2/test" ;;
        3) binary_path="./core/docs/developer_manual/tutorials/hwpe/model_hwpe/application/task3/test" ;;
        4|5|6|7) binary_path="./core/docs/developer_manual/tutorials/hwpe/model_hwpe/application/task4/test" ;;
        8) binary_path="./core/docs/developer_manual/tutorials/hwpe/model_hwpe/application/task8/test" ;;
    ...
    python3 ./core/docs/developer_manual/tutorials/hwpe/test_traces.py $task_number
