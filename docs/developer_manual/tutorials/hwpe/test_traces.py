...
tasks = {
    ...
    6: {
        "patterns": [
            ...
            r"(\d+): (\d+): \[\x1b\[34m/chip/cluster/hwpe/trace\s+\x1b\[0m\] input load max_latency=0, latency=0, addr=0x1d, data=0x22",
            r"(\d+): (\d+): \[\x1b\[34m/chip/cluster/hwpe/trace\s+\x1b\[0m\] input load max_latency=0, latency=0, addr=0x1e, data=0x33",
            r"(\d+): (\d+): \[\x1b\[34m/chip/cluster/hwpe/trace\s+\x1b\[0m\] input load max_latency=0, latency=0, addr=0x1f, data=0x44",
            r"(\d+): (\d+): \[\x1b\[34m/chip/cluster/hwpe/trace\s+\x1b\[0m\] input load max_latency=0, latency=0, addr=0x20, data=0x55",
            r"(\d+): (\d+): \[\x1b\[34m/chip/cluster/hwpe/trace\s+\x1b\[0m\] input load max_latency=0, latency=0, addr=0x21, data=0x66",
            r"(\d+): (\d+): \[\x1b\[34m/chip/cluster/hwpe/trace\s+\x1b\[0m\] input load max_latency=0, latency=0, addr=0x22, data=0x77",
            r"(\d+): (\d+): \[\x1b\[34m/chip/cluster/hwpe/trace\s+\x1b\[0m\] input load max_latency=0, latency=0, addr=0x23, data=0x88",
            r"(\d+): (\d+): \[\x1b\[34m/chip/cluster/hwpe/trace\s+\x1b\[0m\] \(fsm state\) current state LOAD_INPUT finished with latency : 1 cycles",
