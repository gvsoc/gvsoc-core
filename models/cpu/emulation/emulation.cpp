...
emulation::emulation(js::config *config)
    : vp::component(config)
{
}
...
void emulation::data_grant(void *__this, vp::io_req *req)
{
}

void emulation::data_response(void *__this, vp::io_req *req)
{
