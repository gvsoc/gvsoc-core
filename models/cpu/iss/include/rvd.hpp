...
static inline iss_insn_t *fld_exec(Iss *iss, iss_insn_t *insn)
{
...
static inline iss_insn_t *fsd_exec(Iss *iss, iss_insn_t *insn)
{
...
// RV64F
//
static inline iss_insn_t *fcvt_l_d_exec(Iss *iss, iss_insn_t *insn)
{
    REG_SET(0, LIB_FF_CALL2(lib_flexfloat_cvt_l_ff_round, REG_GET(0), 11, 52, UIM_GET(0)));
    return insn->next;
}

static inline iss_insn_t *fcvt_lu_d_exec(Iss *iss, iss_insn_t *insn)
{
    REG_SET(0, LIB_FF_CALL2(lib_flexfloat_cvt_lu_ff_round, REG_GET(0), 11, 52, UIM_GET(0)));
    return insn->next;
}

static inline iss_insn_t *fcvt_d_l_exec(Iss *iss, iss_insn_t *insn)
{
    REG_SET(0, LIB_FF_CALL2(lib_flexfloat_cvt_ff_l_round, REG_GET(0), 11, 52, UIM_GET(0)));
    return insn->next;
}

static inline iss_insn_t *fcvt_d_lu_exec(Iss *iss, iss_insn_t *insn)
{
