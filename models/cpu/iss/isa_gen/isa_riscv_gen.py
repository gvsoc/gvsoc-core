...
rv32v = IsaSubset('v'  , [
    ...
    R5('vfsub.vf'      ,   'OPV'  ,    '000010 - ----- ----- 101 ----- 1010111'),

    R5('vfrsub.vf'     ,   'OPV'  ,    '100111 - ----- ----- 101 ----- 1010111'),

    R5('vfmin.vv'      ,   'OPV'  ,    '000100 - ----- ----- 001 ----- 1010111'),
    R5('vfmin.vf'      ,   'OPV'  ,    '000100 - ----- ----- 101 ----- 1010111'),

    R5('vfmax.vv'      ,   'OPV'  ,    '000110 - ----- ----- 001 ----- 1010111'),
    R5('vfmax.vf'      ,   'OPV'  ,    '000110 - ----- ----- 101 ----- 1010111'),

    R5('vfmul.vv'      ,   'OPV'  ,    '100100 - ----- ----- 001 ----- 1010111'),
    R5('vfmul.vf'      ,   'OPV'  ,    '100100 - ----- ----- 101 ----- 1010111'),

    R5('vfmacc.vv'     ,   'OPV'  ,    '101100 - ----- ----- 001 ----- 1010111'),
    R5('vfmacc.vf'     ,   'OPV'  ,    '101100 - ----- ----- 101 ----- 1010111'),

    R5('vfnmacc.vv'    ,   'OPV'  ,    '101101 - ----- ----- 001 ----- 1010111'),
    R5('vfnmacc.vf'    ,   'OPV'  ,    '101101 - ----- ----- 101 ----- 1010111'),

    R5('vfmsac.vv'     ,   'OPV'  ,    '101110 - ----- ----- 001 ----- 1010111'),
    R5('vfmsac.vf'     ,   'OPV'  ,    '101110 - ----- ----- 101 ----- 1010111'),

    R5('vfnmsac.vv'    ,   'OPV'  ,    '101111 - ----- ----- 001 ----- 1010111'),
    R5('vfnmsac.vf'    ,   'OPV'  ,    '101111 - ----- ----- 101 ----- 1010111'),

    R5('vfmadd.vv'     ,   'OPV'  ,    '101000 - ----- ----- 001 ----- 1010111'),
    R5('vfmadd.vf'     ,   'OPV'  ,    '101000 - ----- ----- 101 ----- 1010111'),

    R5('vfnmadd.vv'    ,   'OPV'  ,    '101001 - ----- ----- 001 ----- 1010111'),
    R5('vfnmadd.vf'    ,   'OPV'  ,    '101001 - ----- ----- 101 ----- 1010111'),

    R5('vfmsub.vv'     ,   'OPV'  ,    '101010 - ----- ----- 001 ----- 1010111'),
    R5('vfmsub.vf'     ,   'OPV'  ,    '101010 - ----- ----- 101 ----- 1010111'),

    R5('vfnmsub.vv'    ,   'OPV'  ,    '101011 - ----- ----- 001 ----- 1010111'),
    R5('vfnmsub.vf'    ,   'OPV'  ,    '101011 - ----- ----- 101 ----- 1010111'),

    R5('vfwadd.vv'     ,   'OPV'  ,    '110000 - ----- ----- 001 ----- 1010111'),
    R5('vfwadd.vf'     ,   'OPV'  ,    '110000 - ----- ----- 101 ----- 1010111'),
    R5('vfwadd.wv'     ,   'OPV'  ,    '110100 - ----- ----- 001 ----- 1010111'),
    R5('vfwadd.wf'     ,   'OPV'  ,    '110100 - ----- ----- 101 ----- 1010111'),

    R5('vfwsub.vv'     ,   'OPV'  ,    '110010 - ----- ----- 001 ----- 1010111'),
    R5('vfwsub.vf'     ,   'OPV'  ,    '110010 - ----- ----- 101 ----- 1010111'),
    R5('vfwsub.wv'     ,   'OPV'  ,    '110110 - ----- ----- 001 ----- 1010111'),
    R5('vfwsub.wf'     ,   'OPV'  ,    '110110 - ----- ----- 101 ----- 1010111'),

    R5('vfwmul.vv'     ,   'OPV'  ,    '111000 - ----- ----- 001 ----- 1010111'),
    R5('vfwmul.vf'     ,   'OPV'  ,    '111000 - ----- ----- 101 ----- 1010111'),

    R5('vfwmacc.vv'    ,   'OPV'  ,    '111100 - ----- ----- 001 ----- 1010111'),
    R5('vfwmacc.vf'    ,   'OPV'  ,    '111100 - ----- ----- 101 ----- 1010111'),

    R5('vfwmsac.vv'    ,   'OPV'  ,    '111110 - ----- ----- 001 ----- 1010111'),
    R5('vfwmsac.vf'    ,   'OPV'  ,    '111110 - ----- ----- 101 ----- 1010111'),

    R5('vfwnmsac.vv'   ,   'OPV'  ,    '111111 - ----- ----- 001 ----- 1010111'),
    R5('vfwnmsac.vf'   ,   'OPV'  ,    '111111 - ----- ----- 101 ----- 1010111'),

    R5('vfsgnj.vv'     ,   'OPV'  ,    '001000 - ----- ----- 001 ----- 1010111'),
    R5('vfsgnj.vf'     ,   'OPV'  ,    '001000 - ----- ----- 101 ----- 1010111'),

    R5('vfsgnjn.vv'    ,   'OPV'  ,    '001001 - ----- ----- 001 ----- 1010111'),
    R5('vfsgnjn.vf'    ,   'OPV'  ,    '001001 - ----- ----- 101 ----- 1010111'),

    R5('vfsgnjx.vv'    ,   'OPV'  ,    '001010 - ----- ----- 001 ----- 1010111'),
    R5('vfsgnjx.vf'    ,   'OPV'  ,    '001010 - ----- ----- 101 ----- 1010111'),
    
    R5('vfcvt.f.x.v'   ,   'OPV'  ,    '010010 - ----- 00011 001 ----- 1010111'),

    R5('vfmv.v.f'      ,   'OPV'  ,    '010111 - ----- ----- 101 ----- 1010111'),
