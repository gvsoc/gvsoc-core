...
class Xfvec(IsaSubset):
    ...
    def __init__(self):
        ...
        # For F
        #
            Instr('vfadd.s',    Format_RVF, '1000001 ----- ----- 000 ----- 0110011', tags=['fadd'], isa_tags=['f32vec'], is_fp_op=True),
            Instr('vfadd.r.s',  Format_RVF, '1000001 ----- ----- 100 ----- 0110011', tags=['fadd'], isa_tags=['f32vec'], is_fp_op=True),
            Instr('vfsub.s',    Format_RVF, '1000010 ----- ----- 000 ----- 0110011', tags=['fadd'], isa_tags=['f32vec'], is_fp_op=True),
            Instr('vfsub.r.s',  Format_RVF, '1000010 ----- ----- 100 ----- 0110011', tags=['fadd'], isa_tags=['f32vec'], is_fp_op=True),
            Instr('vfmul.s',    Format_RVF, '1000011 ----- ----- 000 ----- 0110011', tags=['fmul'], isa_tags=['f32vec'], is_fp_op=True),
            Instr('vfmul.r.s',  Format_RVF, '1000011 ----- ----- 100 ----- 0110011', tags=['fmul'], isa_tags=['f32vec'], is_fp_op=True),
            ...
            Instr('vfmac.s',    Format_RVF4,'1001000 ----- ----- 000 ----- 0110011', tags=['fmadd'], isa_tags=['f32vec'], is_fp_op=True),
            Instr('vfmac.r.s',  Format_RVF4,'1001000 ----- ----- 100 ----- 0110011', tags=['fmadd'], isa_tags=['f32vec'], is_fp_op=True),
            Instr('vfmre.s',    Format_RVF4,'1001001 ----- ----- 000 ----- 0110011', tags=['fmadd'], isa_tags=['f32vec'], is_fp_op=True),
            Instr('vfmre.r.s',  Format_RVF4,'1001001 ----- ----- 100 ----- 0110011', tags=['fmadd'], isa_tags=['f32vec'], is_fp_op=True),
            
            Instr('vfsum.s',   Format_RVF3,'1000111 11100 ----- 000 ----- 0110011', tags=['fadd'], isa_tags=['f32vec'], is_fp_op=True),

            # Instr('vfclass.s', Format_R2VF2,'1001100 00001 ----- 000 ----- 0110011', tags=['fother'], isa_tags=['f32vec']),

            Instr('vfsgnj.r.s', Format_RVF, '1001101 ----- ----- 100 ----- 0110011', tags=['fconv'], isa_tags=['f32vec'], is_fp_op=True),
            Instr('vfsgnj.s',   Format_RVF, '1001101 ----- ----- 000 ----- 0110011', tags=['fconv'], isa_tags=['f32vec'], is_fp_op=True),
            Instr('vfsgnjn.s',  Format_RVF, '1001110 ----- ----- 000 ----- 0110011', tags=['fconv'], isa_tags=['f32vec'], is_fp_op=True),
            Instr('vfsgnjn.r.s',Format_RVF, '1001110 ----- ----- 100 ----- 0110011', tags=['fconv'], isa_tags=['f32vec'], is_fp_op=True),
            Instr('vfsgnjx.s',  Format_RVF, '1001111 ----- ----- 000 ----- 0110011', tags=['fconv'], isa_tags=['f32vec'], is_fp_op=True),
            Instr('vfsgnjx.r.s',Format_RVF, '1001111 ----- ----- 100 ----- 0110011', tags=['fconv'], isa_tags=['f32vec'], is_fp_op=True),

            Instr('vfeq.s',    Format_R2VF, '1010000 ----- ----- 000 ----- 0110011', tags=['fother'], isa_tags=['f32vec'], is_fp_op=True, isn_seq_op=True),
            ...
            Instr('vfcpka.s.s', Format_RVF, '1011000 ----- ----- 000 ----- 0110011', tags=['fother'], isa_tags=['f32vec'], is_fp_op=True),
