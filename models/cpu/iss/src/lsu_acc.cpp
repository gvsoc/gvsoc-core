...
void Lsu::data_retry(vp::Block *__this)
{
// #ifdef CONFIG_GVSOC_ISS_LSU_NB_OUTSTANDING
...
void Lsu::data_response(vp::Block *__this, vp::IoAccReq *req)
{
//     Lsu *_this = (Lsu *)__this;
//     Iss *iss = &_this->iss;
...
Lsu::Lsu(IssWrapper &top, Iss &iss)
    ...
    data(&Lsu::data_retry, &Lsu::data_response)
{
}
...
void Lsu::store_resume(Lsu *lsu, vp::IoAccReq *req)
{
...
void Lsu::load_resume(Lsu *lsu, vp::IoAccReq *req)
{
...
void Lsu::elw_resume(Lsu *lsu, vp::IoAccReq *req)
{
...
void Lsu::load_signed_resume(Lsu *lsu, vp::IoAccReq *req)
{
#ifdef CONFIG_GVSOC_ISS_LSU_NB_OUTSTANDING
    int req_id = *((int *)req->arg_get(0));
    int reg = lsu->stall_reg[req_id];
...
void Lsu::load_float_resume(Lsu *lsu, vp::IoAccReq *req)
{
#ifdef CONFIG_GVSOC_ISS_LSU_NB_OUTSTANDING
    int req_id = *((int *)req->arg_get(0));
    int reg = lsu->stall_reg[req_id];
...
//     if (opcode == vp::IoAccReqOpcode::LR)
//     {
//         bool use_mem_array;
