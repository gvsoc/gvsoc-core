...
public:
    ...
    bool mideleg_access(iss_insn_t *insn, bool is_write, iss_reg_t &value);
    bool mip_access(iss_insn_t *insn, bool is_write, iss_reg_t &value);
    bool mie_access(iss_insn_t *insn, bool is_write, iss_reg_t &value);
    bool sip_access(iss_insn_t *insn, bool is_write, iss_reg_t &value);
    bool sie_access(iss_insn_t *insn, bool is_write, iss_reg_t &value);
    bool mtvec_access(iss_insn_t *insn, bool is_write, iss_reg_t &value);
    bool stvec_access(iss_insn_t *insn, bool is_write, iss_reg_t &value);

    bool mtvec_set(iss_addr_t base);
    bool stvec_set(iss_addr_t base);
    void global_enable(int enable);
    void cache_flush();
