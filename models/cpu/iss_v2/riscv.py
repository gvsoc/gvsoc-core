...
class EventEmpty(IssModule):
    def gen(self, iss):
        iss.isa.add_define('CONFIG_GVSOC_ISS_EVENT', 'EventEmpty')
        iss.isa.add_include('<cpu/iss_v2/include/event/empty.hpp>')
