...
class Regmap(object):
    ...
    def dump_to_rst(self, rst, pretty_name, addmap_ref):
...
def dump_to_rst(regmap, name, rst_path, pretty_name, addmap_ref):
    rst_file = Rst_file(name, rst_path)
    regmap.dump_to_rst(rst_file, pretty_name, addmap_ref)
    rst_file.close()
