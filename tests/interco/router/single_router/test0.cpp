...
static TestCase testcases[] =
{
    ...
    { "4 generators from 2 different router inputs to 1 receiver", 1024, 2, 2, 1, 0.05f},
    { "2 generators from 1 router input to 2 memories", 2048, 1, 2, 2, 0.05f},
    { "2 generators from 2 router inputs to 2 memories", 2048, 2, 1, 2, 0.05f},
    { "4 generators from 2 router inputs to 2 memories", 2048, 2, 2, 2, 0.05f},
    { "8 generators from 4 router inputs to 4 memories", 2048, 4, 2, 4, 0.05f},
    ...
    // target
    { "8 generators from 4 router inputs to 2 memories", 2048, 4, 2, 2, 0.15f},
};
...
void Test0::entry(vp::Block *__this, vp::ClockEvent *event)
{
    ...
    size_t bw1 = _this->top->bandwidth;
    ...
    else
    {
        ...
        printf("    Done (size: %d, bw: %ld, cycles: %ld, expected: %ld)\n",
            testcase->size, bw1, cycles, expected);
